...
namespace preemptive_executor {
    ...
    class CallbackEntity {
      public:
        ...
        CallbackEntityType get_type() const {
            return type_;
        }
        ...
        const EntityVariant& get_generic_pointer() const {
            return entity_;
        }

        // Equality operator for use as map key
        bool operator==(const CallbackEntity& other) const {
