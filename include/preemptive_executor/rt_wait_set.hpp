...
#ifndef PREEMPTIVE_EXECUTOR__WAIT_SET_HPP_
#define PREEMPTIVE_EXECUTOR__WAIT_SET_HPP_
...
#include "rt_wait_set_template.hpp"
 ...
 */
using RTWaitSet = preemptive_executor::RTWaitSetTemplate<
...
>
using StaticRTWaitSet = preemptive_executor::RTWaitSetTemplate<
  rclcpp::wait_set_policies::SequentialSynchronization,
 ...
 * \sa rclcpp::WaitSetTemplate for API documentation
 */
using ThreadSafeRTWaitSet = preemptive_executor::RTWaitSetTemplate<
...
#endif  // PREEMPTIVE_EXECUTOR__WAIT_SET_HPP_
