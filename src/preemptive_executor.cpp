...
namespace preemptive_executor
{
    ...
    void PreemptiveExecutor::collect_entities()
    {
        ...
        // Build the WeakCallbackGroupsToNodesMap by using entities from current_collection_
        // Each entity has a callback group. We'll collect unique callback groups and
        // try to find their associated nodes by checking if callback groups belong to nodes.
        // Since we don't have direct access to nodes, we'll use entities to infer the relationship.
